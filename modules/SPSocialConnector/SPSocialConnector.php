...
class SPSocialConnector extends CRMEntity {
    ...
    function vtlib_handler($modulename, $event_type) {
		...
		// Removing duplicates, no idea how they came ...
		$adb->pquery('DELETE FROM vtiger_links WHERE tabid=? AND linktype=? AND linklabel=? AND linkurl like',
				Array("57", "DETAILVIEWBASIC", "LBL_CHECK_STATUS", "%javascript:SocialServiceConnector%"));
        ...
        if($unregisterLinks) {
                ...
                $socialserviceconnectorModuleInstance->deleteLink("HEADERSCRIPT", "SPSocialConnectorCommonJS", "modules/SPSocialConnector/SPSocialConnectorCommon.js");
        ...
        if($registerLinks) {
                ...
                $socialserviceconnectorModuleInstance = Vtiger_Module::getInstance('SPSocialConnector');
                $socialserviceconnectorModuleInstance->addLink("HEADERSCRIPT", "SPSocialConnectorCommonJS", "modules/SPSocialConnector/SPSocialConnectorCommon.js");
                
                $leadsModuleInstance = Vtiger_Module::getInstance('Leads');
                $leadsModuleInstance->addLink("DETAILVIEWBASIC", "Send to social nets", "javascript:SPSocialConnectorCommon.displaySelectWizard_DetailView('\$MODULE\$', '\$RECORD\$');", "modules/SPSocialConnector/icons/new_unknown.gif");

                $contactsModuleInstance = Vtiger_Module::getInstance('Contacts');
                $contactsModuleInstance->addLink("DETAILVIEWBASIC", "Send to social nets", "javascript:SPSocialConnectorCommon.displaySelectWizard_DetailView('\$MODULE\$', '\$RECORD\$');", "modules/SPSocialConnector/icons/new_unknown.gif");

                $accountsModuleInstance = Vtiger_Module::getInstance('Accounts');
                $accountsModuleInstance->addLink("DETAILVIEWBASIC", "Send to social nets", "javascript:SPSocialConnectorCommon.displaySelectWizard_DetailView('\$MODULE\$', '\$RECORD\$');", "modules/SPSocialConnector/icons/new_unknown.gif");
    ...
    static function saveMsg($message, $tonumbers, $ownerid = false, $linktoids = false, $linktoModule = false) {
    ...
    // Check message status (success or not)
    static function getMsgStatusInfo($record) {
        global $adb;
        $results = array();
        $qresult = $adb->pquery("SELECT * FROM vtiger_sp_socialconnector_status WHERE socialserviceconnectorid=?", array($record));
