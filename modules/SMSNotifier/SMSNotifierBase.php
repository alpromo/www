	...
	function vtlib_handler($modulename, $event_type) {
		...
		if($unregisterLinks) {
			...
			$accountsModuleInstance->deleteLink('DETAILVIEWBASIC', 'Send SMS');
                        ...
                        // SalesPlatform.ru begin: Add SMS to CRM entity related list
			$leadsModuleInstance->unsetRelatedlist($smsnotifierModuleInstance,'SMSNotifier','get_related_list');
			$contactsModuleInstance->unsetRelatedlist($smsnotifierModuleInstance,'SMSNotifier','get_related_list');
			$accountsModuleInstance->unsetRelatedlist($smsnotifierModuleInstance,'SMSNotifier','get_related_list');
		...
		if($registerLinks) {
			...
			$leadsModuleInstance->addLink("DETAILVIEWBASIC", "Send SMS", "javascript:SMSNotifierCommon.displaySelectWizard_DetailView('\$MODULE\$', '\$RECORD\$');", "themes/images/send_sms.png");
			...
			$contactsModuleInstance->addLink('LISTVIEWBASIC', 'Send SMS', "SMSNotifierCommon.displaySelectWizard(this, '\$MODULE\$');");
                        // SalesPlatform.ru begin Add new icon
			$contactsModuleInstance->addLink("DETAILVIEWBASIC", "Send SMS", "javascript:SMSNotifierCommon.displaySelectWizard_DetailView('\$MODULE\$', '\$RECORD\$');", "themes/images/send_sms.png");
			...
			$accountsModuleInstance->addLink('LISTVIEWBASIC', 'Send SMS', "SMSNotifierCommon.displaySelectWizard(this, '\$MODULE\$');");
                        // SalesPlatform.ru begin Add new icon
			$accountsModuleInstance->addLink("DETAILVIEWBASIC", "Send SMS", "javascript:SMSNotifierCommon.displaySelectWizard_DetailView('\$MODULE\$', '\$RECORD\$');", "themes/images/send_sms.png");
                        ...
                        // SalesPlatform.ru begin: Add SMS to CRM entity related list
			$leadsModuleInstance->setRelatedlist($smsnotifierModuleInstance,'SMSNotifier',array(),'get_related_list');
			$contactsModuleInstance->setRelatedlist($smsnotifierModuleInstance,'SMSNotifier',array(),'get_related_list');
			$accountsModuleInstance->setRelatedlist($smsnotifierModuleInstance,'SMSNotifier',array(),'get_related_list');
                        // SalesPlatform.ru end
		}
