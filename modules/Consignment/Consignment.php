		...
		global $adb;
 		...
 		if($eventType == 'module.postinstall') {
			...
			$invoiceInstance->setRelatedlist($consignmentInstance,'Consignment',array(ADD),'get_dependents_list');
                        ...
                        $accountsInstance->setRelatedlist($consignmentInstance,'Consignment',array(ADD),'get_consignments');
			...
			$invoiceInstance->unsetRelatedlist($consignmentInstance,'Consignment','get_dependents_list');
                        ...
                        $accountsInstance->unsetRelatedlist($consignmentInstance,'Consignment','get_consignments');
