...
class ProjectTask extends CRMEntity {
    ...
    function __construct() {
        ...
        // SalesPlatform.ru begin get column fields for Project
        $this->column_fields = getColumnFields('ProjectTask');
   ...
   function save_module($module) {
    ...
    // SalesPlatform.ru begin added history and activities
        /**
	 * Function to get ProjectTask related Task & Event which have activity type Held, Completed or Deferred.
	 * @param  integer   $id - projecttaskid
