		...
		<td class="showPanelBg" valign="top" width="100%">
			<div class="small" style="padding:20px">
				{if $WEBFORM->hasId()}
                                        ...
                                        <span class="lvtHeaderText">{$APP.LBL_EDITING}: {$WEBFORM->getName()}</span> <br>
					{*<span class="lvtHeaderText">Edit : {$WEBFORM->getName()}</span> <br>*}
                                        {* SalesPlatform.ru end *}
				{else}
                                        {* SalesPlatform.ru begin localization for 5.4.0 *}
                                        <span class="lvtHeaderText">{$APP.LBL_CREATING} {$APP.LBL_NEW} {'Webforms'|@getTranslatedString:$MODULE}</span> <br>
