<?php /* Smarty version 2.6.18, created on 2013-11-13 18:53:33
         compiled from Home/MainHomeBlock.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'getTranslatedString', 'Home/MainHomeBlock.tpl', 3, false),array('modifier', 'vtiger_imageurl', 'Home/MainHomeBlock.tpl', 37, false),)), $this); ?>

<?php $this->assign('homepagedashboard_title', getTranslatedString('Home Page Dashboard', 'Home')); ?>
<?php $this->assign('spconfiguration_title', getTranslatedString('LBL_SP_CONFIGURATION', 'System Configuration')); ?>
<?php $this->assign('sphtml_title', getTranslatedString('LBL_SP_HTML', 'HTML Widget')); ?>
...
';</script>
<?php if (( $this->_tpl_vars['tablestuff']['Stufftype'] == 'Default' && $this->_tpl_vars['tablestuff']['Stufftitle'] == $this->_tpl_vars['spconfiguration_title'] )): ?>
<script type="text/javascript">var vtdashboard_defaultDashbaordWidgetTitle = '<?php echo $this->_tpl_vars['spconfiguration_title']; ?>
';</script>
<?php endif; ?>
<div id="stuff_<?php echo $this->_tpl_vars['tablestuff']['Stuffid']; ?>
" class="MatrixLayer <?php if ($this->_tpl_vars['tablestuff']['Stufftitle'] == $this->_tpl_vars['homepagedashboard_title']): ?>twoColumnWidget<?php endif; ?> <?php if ($this->_tpl_vars['tablestuff']['Stufftitle'] == $this->_tpl_vars['spconfiguration_title']): ?>twoColumnWidget<?php endif; ?> <?php if ($this->_tpl_vars['tablestuff']['Stufftitle'] == $this->_tpl_vars['sphtml_title']): ?> twoColumnWidget<?php endif; ?>" style="float:left;overflow-x:hidden;overflow-y:auto;">
...
<?php if (( $this->_tpl_vars['tablestuff']['Stufftype'] != 'Default' || $this->_tpl_vars['tablestuff']['Stufftitle'] != $this->_tpl_vars['keymetrics_title'] ) && ( $this->_tpl_vars['tablestuff']['Stufftype'] != 'Default' || $this->_tpl_vars['tablestuff']['Stufftitle'] != $this->_tpl_vars['homepagedashboard_title'] ) && ( $this->_tpl_vars['tablestuff']['Stufftype'] != 'Default' || $this->_tpl_vars['tablestuff']['Stufftitle'] != $this->_tpl_vars['spconfiguration_title'] ) && ( $this->_tpl_vars['tablestuff']['Stufftype'] != 'Tag Cloud' ) && ( $this->_tpl_vars['tablestuff']['Stufftype'] != 'Notebook' ) && ( $this->_tpl_vars['tablestuff']['Stufftype'] != 'SP_HTML' )): ?>
...
<?php elseif ($this->_tpl_vars['tablestuff']['Stufftitle'] == $this->_tpl_vars['spconfiguration_title']): ?>
				<a style='cursor:pointer;' onclick="fetchConfigurationDiagram(<?php echo $this->_tpl_vars['tablestuff']['Stuffid']; ?>
);">
					<img src="<?php echo vtiger_imageurl('windowRefresh.gif', $this->_tpl_vars['THEME']); ?>
" border="0" alt="<?php echo $this->_tpl_vars['APP']['LBL_REFRESH']; ?>
" title="<?php echo $this->_tpl_vars['APP']['LBL_REFRESH']; ?>
...
<?php elseif ($this->_tpl_vars['tablestuff']['Stufftype'] == 'Default' && $this->_tpl_vars['tablestuff']['Stufftitle'] != $this->_tpl_vars['homepagedashboard_title'] && $this->_tpl_vars['tablestuff']['Stufftitle'] != $this->_tpl_vars['spconfiguration_title'] && $this->_tpl_vars['tablestuff']['Stufftype'] != $this->_tpl_vars['sphtml_title']): ?>
		<tr id="maincont_row_<?php echo $this->_tpl_vars['tablestuff']['Stuffid']; ?>
...
<?php if ($this->_tpl_vars['tablestuff']['Stufftype'] == 'Module' || ( $this->_tpl_vars['tablestuff']['Stufftype'] == 'Default' && $this->_tpl_vars['tablestuff']['Stufftitle'] != 'Key Metrics' && $this->_tpl_vars['tablestuff']['Stufftitle'] != $this->_tpl_vars['homepagedashboard_title'] && $this->_tpl_vars['tablestuff']['Stufftitle'] != $this->_tpl_vars['spconfiguration_title'] && $this->_tpl_vars['tablestuff']['Stufftitle'] != 'My Group Allocation' ) || $this->_tpl_vars['tablestuff']['Stufftype'] == 'RSS' || $this->_tpl_vars['tablestuff']['Stufftype'] == 'DashBoard' || $this->_tpl_vars['tablestuff']['Stufftype'] == 'ReportCharts'): ?>
