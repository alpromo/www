<?php /* Smarty version 2.6.18, created on 2013-11-14 12:01:58
...
<!-- SalesPlatform.ru begin -->
                          <tr>
                            <td class="small cellLabel"><strong><?php echo $this->_tpl_vars['MOD']['LBL_ORGANIZATION_INN']; ?>
</strong></td>
                            <td class="small cellText"><input type="text" name="organization_inn" class="detailedViewTextBox small" value="<?php echo $this->_tpl_vars['ORGANIZATIONINN']; ?>
"></td>
                          </tr>
                          <tr>
                            <td class="small cellLabel"><strong><?php echo $this->_tpl_vars['MOD']['LBL_ORGANIZATION_KPP']; ?>
</strong></td>
                            <td class="small cellText"><input type="text" name="organization_kpp" class="detailedViewTextBox small" value="<?php echo $this->_tpl_vars['ORGANIZATIONKPP']; ?>
"></td>
                          </tr>
                          <tr>
                            <td class="small cellLabel"><strong><?php echo $this->_tpl_vars['MOD']['LBL_ORGANIZATION_BANKACCOUNT']; ?>
</strong></td>
                            <td class="small cellText"><input type="text" name="organization_bankaccount" class="detailedViewTextBox small" value="<?php echo $this->_tpl_vars['ORGANIZATIONBANKACCOUNT']; ?>
"></td>
                          </tr>
                          <tr>
                            <td class="small cellLabel"><strong><?php echo $this->_tpl_vars['MOD']['LBL_ORGANIZATION_BANKNAME']; ?>
</strong></td>
                            <td class="small cellText"><input type="text" name="organization_bankname" class="detailedViewTextBox small" value="<?php echo $this->_tpl_vars['ORGANIZATIONBANKNAME']; ?>
"></td>
                          </tr>
                          <tr>
                            <td class="small cellLabel"><strong><?php echo $this->_tpl_vars['MOD']['LBL_ORGANIZATION_BANKID']; ?>
</strong></td>
                            <td class="small cellText"><input type="text" name="organization_bankid" class="detailedViewTextBox small" value="<?php echo $this->_tpl_vars['ORGANIZATIONBANKID']; ?>
"></td>
                          </tr>
                          <tr>
                            <td class="small cellLabel"><strong><?php echo $this->_tpl_vars['MOD']['LBL_ORGANIZATION_CORRACCOUNT']; ?>
</strong></td>
                            <td class="small cellText"><input type="text" name="organization_corraccount" class="detailedViewTextBox small" value="<?php echo $this->_tpl_vars['ORGANIZATIONCORRACCOUNT']; ?>
"></td>
                          </tr>
                          <tr>
                            <td class="small cellLabel"><strong><?php echo $this->_tpl_vars['MOD']['LBL_ORGANIZATION_DIRECTOR']; ?>
</strong></td>
                            <td class="small cellText"><input type="text" name="organization_director" class="detailedViewTextBox small" value="<?php echo $this->_tpl_vars['ORGANIZATIONDIRECTOR']; ?>
"></td>
                          </tr>
                          <tr>
                            <td class="small cellLabel"><strong><?php echo $this->_tpl_vars['MOD']['LBL_ORGANIZATION_BOOKKEEPER']; ?>
</strong></td>
                            <td class="small cellText"><input type="text" name="organization_bookkeeper" class="detailedViewTextBox small" value="<?php echo $this->_tpl_vars['ORGANIZATIONBOOKKEEPER']; ?>
"></td>
                          </tr>
                          <tr>
                            <td class="small cellLabel"><strong><?php echo $this->_tpl_vars['MOD']['LBL_ORGANIZATION_ENTREPRENEUR']; ?>
</strong></td>
                            <td class="small cellText"><input type="text" name="organization_entrepreneur" class="detailedViewTextBox small" value="<?php echo $this->_tpl_vars['ORGANIZATIONENTREPRENEUR']; ?>
"></td>
                          </tr>
                          <tr>
                            <td class="small cellLabel"><strong><?php echo $this->_tpl_vars['MOD']['LBL_ORGANIZATION_ENTREPRENEURREG']; ?>
</strong></td>
                            <td class="small cellText"><input type="text" name="organization_entrepreneurreg" class="detailedViewTextBox small" value="<?php echo $this->_tpl_vars['ORGANIZATIONENTREPRENEURREG']; ?>
"></td>
                          </tr>
                          <tr> 
                            <td class="small cellLabel"><strong><?php echo $this->_tpl_vars['MOD']['LBL_ORGANIZATION_OKPO']; ?>
</strong></td> 
                            <td class="small cellText"><input type="text" name="organization_okpo" class="detailedViewTextBox small" value="<?php echo $this->_tpl_vars['ORGANIZATIONOKPO']; ?>
"></td> 
                          </tr>
