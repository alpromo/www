<?php /* Smarty version 2.6.18, created on 2013-11-13 18:53:32
         compiled from Header.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'getTranslatedString', 'Header.tpl', 15, false),array('modifier', 'vtiger_imageurl', 'Header.tpl', 89, false),array('modifier', 'escape', 'Header.tpl', 178, false),array('modifier', 'vtlib_purify', 'Header.tpl', 372, false),)), $this); ?>
...
");</style>
                <style type="text/css">@import url("themes/style.css?v=<?php echo $this->_tpl_vars['VERSION']; ?>
");</style>
...
<TABLE border=0 cellspacing=0 cellpadding=0 width=100% class="small">
	<tr>
            <td valign=center style="height: 4.2em;"><img src="test/logo/<?php echo $this->_tpl_vars['LOGO']; ?>
" alt="<?php echo $this->_tpl_vars['LOGO']; ?>
" title="<?php echo $this->_tpl_vars['LOGO']; ?>
" border=0 style="max-width: 15em;max-height: 4.2em;"></td>
...
<div  id="usersettings" class="drop_mnu_user" onmouseout="fnHideDrop('usersettings');" onmouseover="fnvshNrm('usersettings');"  style="width:110px;left:1226px;">
	<table border=0 width="100%" border="0" cellpadding="0" cellspacing="0" >
        <tr >
			<td style="padding-left:0px;padding-right:10px font-weight:bold"  nowrap> <a href="http://community.salesplatform.ru/vtiger_links.php/wiki?version=540" target="_blank" class="drop_down_usersettings"><?php echo $this->_tpl_vars['APP']['LNK_HELP']; ?>
</a> </td>
        </tr>
        <tr >
			<td style="padding-left:0px;padding-right:10px font-weight:bold"  nowrap> <a href="http://community.salesplatform.ru/vtiger_links.php/community" target="_blank" class="drop_down_usersettings"><?php echo $this->_tpl_vars['APP']['LNK_COMMUNITY']; ?>
</a> </td>
        </tr>
	</table>
</div>
