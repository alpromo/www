...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'Home/Homestuff.tpl', 23, false),array('modifier', 'getTranslatedString', 'Home/Homestuff.tpl', 36, false),array('modifier', 'count', 'Home/Homestuff.tpl', 57, false),array('modifier', 'array_reverse', 'Home/Homestuff.tpl', 58, false),)), $this); ?>
 ...
 ?>
				<script>
						...
						fetch_homeDB(<?php echo $this->_tpl_vars['tablestuff']['Stuffid']; ?>
										...
										<?php elseif ($this->_tpl_vars['tablestuff']['Stufftype'] == 'Default' && $this->_tpl_vars['tablestuff']['Stufftitle'] == getTranslatedString('LBL_SP_CONFIGURATION', 'System Configuration')): ?>
						fetchConfigurationDiagram(<?php echo $this->_tpl_vars['tablestuff']['Stuffid']; ?>
);
...
if ($this->_foreach['homeframe']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['index'] => $this->_tpl_vars['tablestuff']):
        $this->_foreach['homeframe']['iteration']++;
?>
		<?php if (( $this->_tpl_vars['tablestuff']['Stufftype'] != 'Default' || ( $this->_tpl_vars['tablestuff']['Stufftitle'] != getTranslatedString('Home Page Dashboard', 'Home') && $this->_tpl_vars['tablestuff']['Stufftitle'] != getTranslatedString('LBL_SP_CONFIGURATION', 'System Configuration') ) ) && $this->_tpl_vars['tablestuff']['Stufftype'] != 'DashBoard' && $this->_tpl_vars['tablestuff']['Stufftype'] != 'ReportCharts'): ?>
			{
